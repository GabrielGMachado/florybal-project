    ...
    <div className={`${poppins.className}`}>
      ...
      <div className="h-full w-full flex justify-center mt-[100px] lg:mt-[175px]">
        <div className="rounded-[15px] p-6 w-[450px] border-yellow-950 bg-white sm:border">
          <h1 className="font-medium mb-5 text-[35px]">Registrar-se</h1>

          <form action="" className="flex flex-col gap-5">

          <div className="flex gap-[32px] sm:gap-[50px]">
              <div>
              <label htmlFor="email" className="font-medium text-yellow-950">Nome</label>
              <input type="text" name="senha" id="senha" placeholder="Ex: Cristiano"
                className="py-2.5 px-4 border border-yellow-950 rounded-[10px] max-w-[175px]"/>
              </div>
              <div> 
              <label htmlFor="email" className="font-medium text-yellow-950">Sobrenome</label>
              <input type="text" name="senha" id="senha" placeholder="Ex: Ronaldo"
                className="py-2.5 px-4 border border-yellow-950 rounded-[10px] max-w-[175px]"/>
              </div>
            </div>
            ...
            <div className="flex justify-center border rounded-[10px] py-2 bg-yellow-950">
            <input type="submit" value="Criar conta" className="font-normal text-white"/>
            </div>
            ...
            <p className="text-zinc-500">já tem conta? <span className="underline hover:text-yellow-950 cursor-pointer">Fazer login</span></p>
            </div>
          </form>
